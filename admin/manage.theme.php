...
?>
    ...
    <div class="container m-0 p-0">
        <div class="row">
            ...
            <div class="col-9 admintable mt-5 mb-5">
                <h5>Hantera säsonger</h5>
                <table class="table table-bordered mt-5">
                    ...
                    <?php
                        ...
                        $sql = 'SELECT * FROM theme ORDER BY theme_title';
                        //Prepare a query
                        ...
                        if ($stmt->rowCount()>0) {
                            ...
                            while ($row = $stmt->fetch()) {
                                ...
                                echo ' 
                                    <tbody>
                                        <tr>
                                            <td>'.ucfirst($row['theme_title']).'</td>
                                            <td>    
                                                <a href="admin.php?delete_theme='.($row['theme_id']).'">
