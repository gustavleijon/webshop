...
// Proces to send a message 
require_once 'functions/uppload.comment.php'
?>
<?php
    // Creates, prepares, and executes a query
    $sql = 'SELECT photos.*, users.firstname, users.lastname, users.email
    FROM photos
    INNER JOIN users ON photos.uid = users.uid
    ORDER BY photos.senddate DESC';
                                    ...
                                    <div class="card border-0">
                                        <div class="card-body">
                                            <ul class="list-unstyled">
                                                <li>
                                                    <a href="admin.inbox.php?uid='.$innerRow['uid'].'" class="d-flex justify-content-between">
